...
public class ExternalCompanyPaging {
	final int PAGEBLOCKCNT = 10;
	
	public ExternalCompanyPaging() throws Exception{
	...
	public ArrayList<String> load() throws Exception{
			...
			setTotalPage(externalCompany.getTotalPage());
	...
	public Object[] loadCompanyByNumber() throws Exception{
		CompanyList companyList = new CompanyList();
			ExternalExportCompanyPanel externalExportCompanyPanel = new ExternalExportCompanyPanel();
			...
			companyList.load();
			externalExportCompanyPanel.setCompanyList(companyList);
			externalExportCompanyPanel.setCompanyPaging(this);
			
			return new Object[]{new Refresh(externalExportCompanyPanel)};
	}
