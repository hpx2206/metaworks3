...
public class ExportAgentPaging {
final int PAGEBLOCKCNT = 10;
	
	public ExportAgentPaging() throws Exception{
	...
	public ArrayList<String> load() throws Exception{
			IExportAgent exportAgent = new ExportAgent();
			setTotalPage(exportAgent.getTotalPage());
	...
	public Object[] loadCompanyByNumber() throws Exception{
		CompanyList companyList = new CompanyList();
			ExportAgentPanel exportAgentPanel = new ExportAgentPanel();
			exportAgentPanel.load();
			companyList.getMetaworksContext().setHow("ExportAgent");
			
			companyList.setCurrentPage(getCurrentPageNo());
			companyList.load();
			exportAgentPanel.setCompanyList(companyList);
			exportAgentPanel.setCompanyPaging(this);
			
			return new Object[]{new Refresh(exportAgentPanel)};
	}
