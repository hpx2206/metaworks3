...
/*		if(session!=null){
		...
		if(session!=null){
			...
			if("region".equals(session.getLastPerspecteType()))
				this.getMetaworksContext().setHow("region");
			
			if("market".equals(session.getLastPerspecteType()))
				this.getMetaworksContext().setHow("market");
