var org_uengine_processmarket_MarketItemPanel = function(objectId, className){
	this.objectId = objectId;
	this.className = className;
	
	this.divId = "#objDiv_" + objectId;
	
	$('.marketItem').hover(function(){
		$(this).find('.marketItemDetail').show('clip',200);
	},function(){
		$(this).find('.marketItemDetail').hide('clip',200);
	})
	
	var panelSize = $(this.divId).width();
	...
	$(function(){
		...
		panel_width: panelSize-30, 				//INT - width of gallery panel (in pixels)
