...
insert into marketItem (itemId, categoryId, itemName, description, version, comCode, price, filePath, logoImageFilePath, image1FilePath, regDate, starPoint)
values (0,
...
'uEngine',
10000,
'files\\uEngine\\pn\\1.zip',
'files\\uEngine\\pn\\logo.gif',
'files\\uEngine\\pn\\1.gif',
CURDATE(),
3);
insert into marketItem (itemId, categoryId, itemName, description, version, comCode, price, filePath, logoImageFilePath, image1FilePath, regDate, starPoint)
