var org_uengine_codi_mw3_ide_libraries_ProcessNode = function(objectId, className){
...
org_uengine_codi_mw3_ide_libraries_ProcessNode.prototype = {
	loaded : function(){
		if(this.object != null){
