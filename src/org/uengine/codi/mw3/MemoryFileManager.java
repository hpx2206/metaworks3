...
/*
 * @(#)MemoryFileManager.java	1.7 07/02/01
 */
...
public final class MemoryFileManager extends ForwardingJavaFileManager {
	...
	@Override
	public JavaFileObject getJavaFileForInput(Location location, final String name,
			Kind arg2) throws IOException {
		
		if(!classes.containsKey(name))
			return null;
		
		ByteArrayJavaFileManager.ByteArrayJavaFileObject bajfo = new ByteArrayJavaFileManager.ByteArrayJavaFileObject(name, Kind.CLASS){
