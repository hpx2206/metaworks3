var org_uengine_codi_mw3_model_InstanceSearchBox = function(objectId, className) {
	...
	$("#searchButton_" + this.objectId).bind({
...
org_uengine_codi_mw3_model_InstanceSearchBox.prototype = {
	getValue : function() {
		var object = mw3.objects[this.objectId];
	...
	destroy : function(){
		...
		$("#searchButton_" + this.objectId).unbind('click');
