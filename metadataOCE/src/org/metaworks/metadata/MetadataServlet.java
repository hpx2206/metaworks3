...
//		System.out.println("pathInfo = " + pathInfo);
		...
		if(pathInfo.startsWith("/getMetadataFile")){
			...
			if( tenantId != null){
				projectBasePath = MetadataBundleBase.getProjectBasePath(projectId , tenantId);
			}else{
				projectBasePath = MetadataBundleBase.getProjectBasePath(projectId);
			}
			...
			if( !file.exists() ){
				...
				filePath = MetadataBundleBase.getProjectBasePath(projectId) + File.separatorChar + metadataFileName;
			...
			if( metadataType != null ){
				// codebase/appId/root
				projectId = MetadataBundleBase.getProjectId();
				...
				String tenentBasePath = GlobalContext.getCodeBaseRoot();
