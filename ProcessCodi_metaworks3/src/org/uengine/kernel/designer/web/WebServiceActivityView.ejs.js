...
var org_uengine_kernel_designer_web_WebServiceActivityView = function(objectId, className){
...
org_uengine_kernel_designer_web_WebServiceActivityView.prototype = {
        loaded : function(){
            var object = mw3.objects[this.objectId];
            var element = null;
