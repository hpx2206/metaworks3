...
public class JavaCodeEditor extends Editor {
	...
	public JavaCodeEditor(String id) {
		super(id);
	}
	...
	@ServiceMethod(payload = { "id", "name", "filename", "content", "resourceNode" }, mouseBinding = "right", target = ServiceMethodContext.TARGET_STICK)
	...
	public Object runMetaworks(){
		try {
			...
			outputWindow.setPanel("살려야함 cjw");
