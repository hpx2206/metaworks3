...
org_uengine_codi_mw3_model_Window.prototype.minimize = function(innerLayoutName, innerLayout, outerLayoutName, outerLayout){
...
org_uengine_codi_mw3_model_Window.prototype.resume = function(innerLayoutName, innerLayout, outerLayoutName, outerLayout){
...
org_uengine_codi_mw3_model_Window.prototype.close = function(){
    $('#objDiv_' + this.objectId).next('div').hide();
	$('#objDiv_' + this.objectId).hide('clip',100);
