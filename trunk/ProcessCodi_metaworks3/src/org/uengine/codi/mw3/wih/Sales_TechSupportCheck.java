...
public class Sales_TechSupportCheck implements ITool , Serializable {
	String instanceId;
	@Hidden
	...
	@Face(displayName="$SALESTECHSUPPORTCHECK_TECCHSUPPORT_CONTENTS")
	...
	@Face(displayName="$SALESTECHSUPPORTCHECK_SPECIAL_CONTENTS")
