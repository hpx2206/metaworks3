...
public class WorkingCopy {
    ...
    public static void main(String[] args) throws SVNException {
        ...
        String newDir = "/Users/jyjang/newDir";
        ...
        myUpdateEventHandler = new UpdateEventHandler(null);
...
//        
        ...
        final File wcDir2 = new File(myWorkingCopyPath+"_");
        if (wcDir.exists()) {
        ...
        new Thread(){
			...
			public void run() {
			       try {
			             ...
			             */
			            checkout(url, SVNRevision.HEAD, wcDir2, true);
			        } catch (SVNException svne) {
...
//        System.exit(0);
    ...
    private static SVNCommitInfo copy(SVNURL srcURL, SVNURL dstURL,
    	...
    	SVNCopySource[] sources = new SVNCopySource[]{
    			...
    			new SVNCopySource(SVNRevision.HEAD, null, srcURL)
    	};
        
        return ourClientManager.getCopyClient().doCopy(sources, 
                dstURL, isMove, true/* makeParents */, true /*failWhenDstExists*/, "commitMessage", null);
    }
