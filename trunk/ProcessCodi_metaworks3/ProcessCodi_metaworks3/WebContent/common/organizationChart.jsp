...
<script type="text/javascript">
		...
		function searchUser() {
			...
			getUserList(mainForm.column.value, mainForm.key.value, "tableUserList", <%=isMultiple%>, null, null, <%=loggedUserGlobalCom %>); 
			try {
                ...
                <script type="dojo/method" event="onClick" args="item">
					if (item.type == "user") {
						...
						if (item.type == "department") {
							getUserList("partcode", item.code, "tableUserList", <%=isMultiple%>, null, <%= isApproval%>, <%=loggedUserGlobalCom %>);
							try {
								document.getElementById("chkBoxAllUsers").checked = false;
							} catch (e) {}
						}
