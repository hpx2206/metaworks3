...
<%@page import="org.uengine.kernel.GlobalContext"%><%@page import="java.util.HashMap"%><%@page import="java.util.Map"%>
...
<%@ page contentType="text/xml; charset=UTF-8" language="java" import="org.uengine.util.XMLUtil,java.sql.*,javax.sql.*,org.uengine.util.dao.DefaultConnectionFactory"%><%
	...
	Facebook graph_getMyGroup = new Facebook(myappkey, access_token);  
	JSONObject group = graph_getMyGroup.getMyGroupId();
	JSONArray arrayGroup = group.getJSONArray("data");
